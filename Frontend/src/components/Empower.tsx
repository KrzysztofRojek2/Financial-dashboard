...
const empowerFeaturesData = [
  {
    ...
    description:
      'Stay on top of your finances with real-time updates and comprehensive reports',
  },
  {
    title: 'Smart Decisions',
    description:
      'Leverage data-driven insights to make strategic choices for your financial future.',
  },
];
...
const Empower = () => {
  return (
    <div
      id="empower"
      className="bg-[#121826] text-white flex p-10 xl:p-20 gap-30 "
    >
      <div className="flex flex-col xl:w-1/2 gap-10 xl:h-140 justify-between">
        ...
        <p className="text-base md:text-xl">
          Experience seamless financial tracking and insightful analytics. Make

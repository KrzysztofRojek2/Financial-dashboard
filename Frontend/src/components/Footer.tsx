...
const footerSections = [
   ...
   },
   {
     ...
     points: ["Social Media", "Link Twelve", "Community Forum", "Feedback", "Careers", "Partnerships",],
   },
 ];
      ...
      <div className="flex flex-col xl:flex-row justify-between">
         ...
         <div className="flex gap-5 sm:gap-20 justify-around mb-10 xl:mb-0">
            <div className="flex flex-col gap-4">
               <FooterSection header={footerSections[0].header} points={footerSections[0].points}/>
            </div>
            <div className="flex flex-col gap-4">
               <FooterSection header={footerSections[1].header} points={footerSections[1].points}/>
            </div>
            <div className="flex flex-col gap-4">
               <FooterSection header={footerSections[2].header} points={footerSections[2].points}/>
            </div>
         </div>
         <div className="flex flex-col xl:w-1/3 gap-5 items-center xl:items-start ">
            <h2 className="font-medium">Subscribe</h2>
            <p className="text-sm">Join our newsletter for the latest updates and exclusive offers.</p>
            <div className="flex gap-5">
               <InputField id="email" type="email" placeholder="Enter your email" variant="primary"/>

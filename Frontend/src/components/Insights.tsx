...
const Insights = () => {
  return (
    <div
      id="insights"
      className="bg-[#121826] text-white flex flex-col p-10 gap-20 xl:p-20 xl:gap-30"
    >
      <div className="flex flex-col lg:flex-row gap-10">
        <div className="flex flex-col lg:w-1/2 gap-6">
          ...
          <h2 className="text-3xl xl:text-4xl font-bold">
            Explore the Power of Real-Time Financial Data
          </h2>
        </div>
        <p className="text-xl lg:w-1/2">
          Our financial dashboard provides you with real-time data that empowers
          your decision-making. Customize reports to fit your specific needs,
          ensuring you have the insights that matter most. Enjoy a user-friendly
